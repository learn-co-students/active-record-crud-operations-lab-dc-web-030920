...
def can_be_instantiated_and_then_saved
  movie = Movie.new # created a new instance
  movie.title = "This is a title." #Computer already added a title
  movie.save #since used 'Movie.new' we need to manually save it into the db with the .save
end
...
def can_be_created_with_a_hash_of_attributes
  ...
  movie = Movie.create(attributes) # the .create method accepts hashes and arrays and passes the k,v to the initialize method.
end
