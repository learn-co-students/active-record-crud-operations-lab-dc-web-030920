...
def can_be_found_updated_and_saved
  ...
  movie_to_update = Movie.find_by(title:"Awesome Flick")
  movie_to_update.update(title: "Even Awesomer Flick")
...
def can_update_using_update_method
  ...
  movie1 = Movie.find_by(title: "Wat?")
  movie1.update(title:"Wat, huh?")
end
...
def can_destroy_a_single_item
  ...
  movie2 = Movie.find_by(title:"That One Where the Guy Kicks Another Guy Once")
  movie2.delete
end
