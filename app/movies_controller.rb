...
def can_find_using_where_clause_and_be_sorted
  ...
  found_movies.order(:title).reverse_order
end
...
def can_update_using_update_method
  ...
  what = Movie.create(title: "Wat?")
  what.update(title: "Wat, huh?")
...
def can_destroy_a_single_item
  movie1 = Movie.create(title: "That One Where the Guy Kicks Another Guy Once")
  movie1.destroy 
  #Movie 
end
